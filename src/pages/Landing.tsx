      ...
      <section className="w-full max-w-[420px] bg-white rounded-3xl shadow-xl ring-1 ring-black/5 p-8 text-center mx-auto">
        ...
        <div className="mt-10 text-left">
          <div className="rounded-2xl bg-brand-light p-5 leading-relaxed text-sm">
            <p className="font-semibold">For best experience, add this web-app to your home screen.</p>
            <p className="mt-2"><span className="font-semibold">On Android,</span> open the browser menu (⋮) and choose "Add to Home screen" or "Install".</p>
            <p className="mt-2"><span className="font-semibold">On iOS,</span> tap the "Share" button and select "Add to Home Screen".</p>
          </div>
        </div>
